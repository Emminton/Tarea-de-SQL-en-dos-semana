...
---segundo problema
 ...
 --mustra las columnas de la tabla libros
 exec sp_columns libros;
...
--inregas registro a la tabla libros
...
--ingresa algunos valores "null" rara los campos que los admitan:
